...
Next, load session3.php in your browser; this destroys the current session. Finally, load session2.php in your session2.php in your browser again.
You'll get an output says indexes "myFavFood", "myFavDrink", and "myFavColor" are all undefined. This indicates that the session no longer exists.
